#StackOverflow-lite/app/tests/v1/test_questions.py
...
class QuestionTestCase(unittest.TestCase):
    ...
    def test_update_question(self):
        ...
        self.app.post("/api/v1/questions/1/body",
                      headers={'Content-Type': 'application/json'}, data=json.dumps(self.question))
        response = self.app.patch("/api/v1/questions/1/body", headers={'Content-Type': 'application/json'},
    ...
    def test_update_nonexixstnce_question(self):
        ...
        response = self.app.patch("/api/v1/questions/17232/body", headers={'Content-Type': 'application/json'},
                                  data=json.dumps({"question": "How do i start using pytest"}))
        result = json.loads(response.data)
        self.assertEqual(response.status_code, 200)
        self.assertIn('question does not exist', str(result))
